...
Landscape alteration has been relatively recent, with one estimate that developed lands increased in California by 38% from 1973 to 2000 [@Sleeter11]. Development prior to 2001 was generally not required to incorporate stormwater structural mitigation measures, such as site design and treatment controls, which are now required statewide to match pre-development hydrologic flows and to treat and prevent pollutants from leaving developed areas [@SDWB01].  For analysis, the state was evaluated as a whole and by major regions defined by hydrologic and geopolitical boundaries (Figure \@ref(fig:calimap)a): Central Valley (CV), Chaparral (CH), Deserts and Modoc Plateau (DM), North Coast (NC), Sierra Nevada (SN), and South Coast (SC). Some of these regions have large urban areas (SC, CH) or agriculture (CV), whereas others are largely forested, but may be impacted by silviculture or logging (NC, SN).
