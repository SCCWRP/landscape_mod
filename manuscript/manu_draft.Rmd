...
* Classification, prioritization, Figures \@ref(fig:sgrresplo), \@ref(fig:sgrresmap) 
...
senscls <- sensres %>% 
  ...
  unnest %>% 
  mutate(
    thrsh = factor(thrsh, levels = c('0.63', '0.79', '0.89'), labels = c('0.63 (conservative)', '0.79', '0.89 (relaxed)')),
          ...
          arrangeGrob(
            arrangeGrob(
              ...
              arrangeGrob(
                ...
                arrangeGrob(p1, p4, p7, textGrob('0.63 (conservative)', rot = 270, gp = grobsz), ncol = 4, widths = c(1, 1, 1, 0.1)), 
                arrangeGrob(p2, p5, p8, textGrob('0.79', rot = 270, gp = grobsz), ncol = 4, widths = c(1, 1, 1, 0.1)), 
                arrangeGrob(p3, p6, p9, textGrob('0.89 (relaxed)', rot = 270, gp = grobsz), ncol = 4, widths = c(1, 1, 1, 0.1)),
