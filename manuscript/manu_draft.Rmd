...
Model performance was comparable to similar studies that focused on developing predictions of biological condition from geospatial data.  Statewide, model predictions for the validation dataset were accurate and precise, with unbiased linear models and strong orrelations between predicted and observed values.  Performance was also high in regions with strong development gradients.  


However, we emphasize that our model did not have the sole intention of 
