...
lucol <- c('khaki2', 'lightsalmon', 'lightgrey')
...
luplo <- sgrlu %>% 
  ...
  mutate(`Land cover` = factor(`Land cover`, levels = c(5, 4, 3, 2, 1), labels = c('Urban: hi', 'Urban: md', 'Urban: lo', 'Open: forest', 'Open: scrub'))) 
...
p2 <- ggplot() +
  ...
  ggtitle('(b) Reach predictions and station scores for the CSCI')
p2leg <- g_legend(p2) 
